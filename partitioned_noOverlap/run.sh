echo "sdss * sdss"
time mpirun -machinefile hosts ./main FileList/SDSS_outOrder 120 10000000 0 FileList/SDSS_outOrder 120 10000000 0 > sdss_sdss_log
echo "2mass * 2mass"
time mpirun -machinefile hosts ./main FileList/2MASS_list 120 3924941 0 FileList/2MASS_list 120 3924941 0 > 2mass_2mass_log
echo "wise * wise"
