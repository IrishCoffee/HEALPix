...
int main(int argc, char* argv[])
{
	...
	struct timeval phase23_start,phase23_end;
...
#pragma omp parallel num_threads(2)
	...
	gettimeofday(&phase23_start,NULL);
	...
	gettimeofday(&phase23_end,NULL);
	printf("rank-%d phase23 %.3f s\n",rank,diffTime(phase23_start,phase23_end) * 0.001);
